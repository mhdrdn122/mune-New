...
/**
 * Breadcrumbs used for navigation in the header
 */
const breadcrumbs = [
  {
    label: "الرئيسية",
...
const AdsPage = () => {
  ...
  return (
    <div>
      {/* Page header with breadcrumb, title, and add button */}
      {/* <PageHeader
        breadcrumbs={breadcrumbs}
        buttonText={"إضافة"}
        heading={"الإعلانات"}
        onButtonClick={() => setShowAddAdv(true)}
        refresh={refresh}
        requiredPermission={PermissionsEnum.ADVERTISEMENT_ADD}
      ...
      <AdsContainer ads={ads} loading={loading} setPage={setPage} page={page} refresh={refresh}  />
