...
const AdminSidebar = ({ className }) => {
  ...
  const menuItems = [
    ...
    //   show:
    //     !userData?.super &&
    //     userData?.super === undefined &&
    //     hasPermission(PermissionsEnum.MY_RESTAURANTS),
    //   isDivider: true,
    // },
...

    {
      ...
      show:
        hasPermission(PermissionsEnum.TABLE_INDEX) &&
        userData?.restaurant?.is_table === 1,
    },
    ...
    
    {
      ...
      show:
        hasPermission(PermissionsEnum.SERVICE_INDEX) &&
        userData?.restaurant?.is_order === 1,
    },

    {
      title: "الرجوع الى قسم السوبر ادمن",
      to: "/super_admin",
      icon: <BsSkipBackwardCircleFill />,
      show: userData?.super === true,
    },
     {
      isDivider: true,
      show: true,
