    ...
    <Accordion className="bg-white">
      ...
      >
        <div className="flex gap-5 justify-center items-center">
          <img
            src={selectedSize?.image?.length>0? selectedSize?.image : item?.image}
      ...
      <AccordionDetails>
        <div className="flex flex-col justify-center items-center w-full">
          ...
          <span
            ...
            className="w-[60%] text-center py-1 rounded-3xl self-center hover:cursor-pointer bg-blue-950 border-2 border-gray-600 text-white mt-2"
          >
            +{total}
          </span>
        </div>
