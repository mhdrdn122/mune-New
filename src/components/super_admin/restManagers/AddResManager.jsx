...
import { useAddRestManagerMutation } from "../../../redux/slice/super_admin/restManagers/restManagerApi";
import useError401 from "../../../hooks/useError401 ";

const AddResManager = ({ show, handleClose }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      // const result = await addRestManager(values)
      //   .unwrap()
      //   .then((payload) => console.log("fulfilled", payload))
      //   .catch((error) => console.error("rejected", error));
      try {
        const result = await addRestManager(values).unwrap();
