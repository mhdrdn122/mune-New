...
const baseURL = axios.create({baseURL:"http://192.168.1.35:8000"})  // الإصدار الجديد
...
// export const baseURLPublicName ="https://tmenuback.addresses.sy" //local

// تحديث عنوان API العام
export const baseURLPublicName ="http://192.168.1.35:8000" // الإصدار الجديد
